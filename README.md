...
Only implement OAuth if you plan to distribute your application across multiple workspaces. A separate `app-prod.ts` file can be found with relevant OAuth settings.
